...
const copy = {
  sr: {
    ...
    features: [
      ["01", "Cockpit bez buke", "Kontinuirana i dnevna vožnja, smena i pauza u realnom vremenu na jednom preglednom ekranu."],
      ["02", "56 dana istorije i kontrola", "Usklađeno sa novim EU Paketom za mobilnost I. Pregled svih 56 dana, 10h produžetaka i nedeljnih odmora."],
      ["03", "Smart Tacho 2 BLE (Bez dongla)", "Direktna veza sa fabričkim Bluetooth čipom na VDO DTCO 4.0/4.1a i Stoneridge SE5000."],
      ["04", "100% Read-Only & Sigurno", "Samo za čitanje. Ne menja tahografske podatke i ne zahteva karticu preduzeća."],
    ],
  ...
  en: {
    ...
    features: [
      ["01", "Quiet cockpit", "Continuous and daily driving, shift and break in real time on one focused screen."],
      ["02", "56-day rolling history", "Compliant with EU Mobility Package I. Full 56-day history, 10h extensions, and rest tracking."],
      ["03", "Smart Tacho 2 BLE (Dongle-free)", "Direct connection to factory Bluetooth on VDO DTCO 4.0/4.1a and Stoneridge SE5000."],
      ["04", "100% Read-Only & Safe", "Purely read-only. No company card required and no risk to tachograph calibration or card data."],
    ],
  ...
  de: {
    ...
    features: [
      ["01", "Ruhiges Cockpit", "Ununterbrochene und tägliche Lenkzeit, Schicht und Pause in Echtzeit auf einem Bildschirm."],
      ["02", "56-Tage-Historie & Kontrolle", "Konform mit dem EU-Mobilitätspaket I. Vollständige 56-Tage-Übersicht, 10h-Verlängerungen und Ruhezeiten."],
      ["03", "Smart Tacho 2 BLE (Ohne Dongle)", "Direkte Verbindung zum werksseitigen Bluetooth-Chip von VDO DTCO 4.0/4.1a und Stoneridge SE5000."],
      ["04", "100% Read-Only & Sicher", "Reines Auslesen. Keine Unternehmenskarte erforderlich und keine Veränderung von Tachographendaten."],
    ],
